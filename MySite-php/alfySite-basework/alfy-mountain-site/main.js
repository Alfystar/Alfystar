!function (t) {
    ...
    "/6JT": function (t, e, n) {
        ...
        !function () {
            ...
            function f(t) {
                var e, n = t.config, i = t.styles.transform;
            ...
            function y(t, e) {
                var n = 0, i = 0, o = N.sequences[t.sequence.id];
                o.blocked = !0, e && "onload" === t.config.useDelay && (i = t.config.delay), t.sequence.timer && (n = Math.abs(t.sequence.timer.started - new Date), window.clearTimeout(t.sequence.timer)), t.sequence.timer = {started: new Date}, t.sequence.timer.clock = window.setTimeout(function () {
            ...
            function b(t, e, n) {
                ...
                e.timer && (i = Math.abs(e.timer.started - new Date), window.clearTimeout(e.timer.clock)), e.timer = {started: new Date}, e.timer.clock = window.setTimeout(function () {
            ...
            function S(t) {
                var e = k(t.domEl), n = C(t.config.container), i = E(t.config.container), o = t.config.viewFactor,
                    r = e.height, s = e.width, a = e.top, l = e.left, c = a + r, u = l + s;
                return function () {
                    var e = a + r * o, f = l + s * o, d = c - r * o, p = u - s * o, h = i.y + t.config.viewOffset.top,
                        g = i.x + t.config.viewOffset.left, m = i.y - t.config.viewOffset.bottom + n.height,
            ...
            o.prototype.defaults = {
                ...
                var e = Object.prototype.toString.call(t), n = /^\[object (HTMLCollection|NodeList|Object)\]$/;
        ...
        t.exports = n.p + "assets/apple-icon.png"
    }, "6wzU": function (t, e, n) {
        ...
        !function (t) {
            t.keys().map(t)
        }(n("pax0")), Object.assign(window, {navbarFixedTopAnimation: i.b, scrollRevelation: i.c, navActivePage: i.a})
    }, Kz47: function (t, e, n) {
        ...
        (function (t) {
            ...
            function r() {
                t('nav li a[href=".' + location.pathname + '"]').addClass("active"), "/" == location.pathname && t('nav li a[href="./index.php"]').addClass("active")
            }
        ...
        (function (t) {
            +function (t) {
                ...
                e.prototype.listen = function () {
                    ...
                    var e = this._fullWidth, i = this._fullHeight,
                        o = (t(window).scrollTop(), e / this._targetImage.width), r = t(window).height() - n.OFFSET,
                        s = t(window).width() - n.OFFSET, a = e / i, l = s / r;
        ...
        !function (e, n) {
            ...
            function w(t) {
                var e, n = t.ownerDocument, i = t.nodeName, o = Vt[i];
            ...
            function E(t, e, n, i, o) {
                for (var r, s, a, l, c, u, f = e.createDocumentFragment(), d = [], p = 0, h = t.length; p < h; p++) if ((r = t[p]) || 0 === r) if ("object" === yt.type(r)) yt.merge(d, r.nodeType ? [r] : r); else if (Kt.test(r)) {
                ...
                for (f.textContent = "", p = 0; r = d[p++];) if (i && yt.inArray(r, i) > -1) o && o.push(r); else if (c = yt.contains(r.ownerDocument, r), s = T(f.appendChild(r), "script"), c && C(s), n) for (u = 0; r = s[u++];) Gt.test(r.type || "") && n.push(r);
                return f
            }
            ...
            function _(t, e, n, i) {
                ...
                if (d && (o = E(e, t[0].ownerDocument, !1, t, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
                    ...
                    if (l) for (u = a[a.length - 1].ownerDocument, yt.map(a, j), f = 0; f < l; f++) c = a[f], Gt.test(c.type || "") && !Pt.access(c, "globalEval") && yt.contains(u, c) && (c.src ? yt._evalUrl && yt._evalUrl(c.src) : s(c.textContent.replace(ae, ""), u))
                }
                return t
            }
            ...
            function M(t, e, n) {
                var i, o = ue(t), r = q(t, e, o), s = "border-box" === yt.css(t, "boxSizing", !1, o);
            ...
            function X(t, e, n) {
                var i, o, r, s, a, l, c, u, f = "width" in e || "height" in e, d = this, p = {}, h = t.style,
                    g = t.nodeType && Ut(t), m = Pt.get(t, "fxshow");
                ...
                if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(p)) {
                    ...
                    for (i in p) l || (m ? "hidden" in m && (g = m.hidden) : m = Pt.access(t, "fxshow", {display: c}), r && (m.hidden = !g), g && x([t], !0), d.done(function () {
            ...
            function G(t, e, n) {
                ...
                for (Z(u, c.opts.specialEasing); r < s; r++) if (i = G.prefilters[r].call(c, t, u, c.opts)) return yt.isFunction(i.stop) && (yt._queueHooks(c.elem, c.opts.queue).stop = yt.proxy(i.stop, i)), i;
            ...
            function J(t, e, n, i) {
                ...
                }); else if (n || "object" !== yt.type(e)) i(t, e); else for (o in e) J(t + "[" + o + "]", e[o], n, i)
            }
            ...
            var rt = [], st = n.document, at = Object.getPrototypeOf, lt = rt.slice, ct = rt.concat, ut = rt.push,
                ft = rt.indexOf, dt = {}, pt = dt.toString, ht = dt.hasOwnProperty, gt = ht.toString,
                mt = gt.call(Object), vt = {}, yt = function (t, e) {
                    return new yt.fn.init(t, e)
                }, bt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, wt = /^-ms-/, xt = /-([a-z])/g, Tt = function (t, e) {
            ...
            yt.fn = yt.prototype = {
                ...
                }, push: ut, sort: rt.sort, splice: rt.splice
            }, yt.extend = yt.fn.extend = function () {
                var t, e, n, i, o, r, s = arguments[0] || {}, a = 1, l = arguments.length, c = !1;
                for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || yt.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = s[e], i = t[e], s !== i && (c && i && (yt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && yt.isPlainObject(n) ? n : {}, s[e] = yt.extend(c, r, i)) : void 0 !== i && (s[e] = i));
                return s
            }, yt.extend({
            ...
            var Ct = function (t) {
                function e(t, e, n, i) {
                    var o, r, s, a, l, u, d, p = e && e.ownerDocument, h = e ? e.nodeType : 9;
                ...
                function d(t, e, n) {
                    ...
                    return e.first ? function (e, n, o) {
                        ...
                        } else for (; e = e[i];) if (1 === e.nodeType || s) if (f = e[P] || (e[P] = {}), u = f[e.uniqueID] || (f[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase()) e = e[i] || e; else {
                ...
                function m(t, e, n, o, r, s) {
                    return o && !o[P] && (o = m(o)), r && !r[P] && (r = m(r, s)), i(function (i, s, a, l) {
                        var c, u, f, d = [], p = [], m = s.length, v = i || h(e || "*", a.nodeType ? [a] : a, []),
                            y = !t || !i && e ? v : g(v, d, t, a, l), b = n ? r || (i ? t : m || o) ? [] : s : y;
                ...
                function v(t) {
                    for (var e, n, i, o = t.length, r = x.relative[t[0].type], s = r || x.relative[" "], a = r ? 1 : 0, l = d(function (t) {
                        ...
                        if (n = x.filter[t[a].type].apply(null, t[a].matches), n[P]) {
                            ...
                            return m(a > 1 && p(u), a > 1 && f(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(rt, "$1"), n, a < i && v(t.slice(a, i)), i < o && v(t = t.slice(i)), i < o && f(t))
                        }
                        u.push(n)
                    }
                    return p(u)
                ...
                function y(t, n) {
                    var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                        var u, f, d, p = 0, h = "0", m = i && [], v = [], y = $, b = i || r && x.find.TAG("*", c),
                            w = H += null == y ? 1 : Math.random() || .1, T = b.length;
                        for (c && ($ = s === j || s || c); h !== T && null != (u = b[h]); h++) {
                            if (r && u) {
                                for (f = 0, s || u.ownerDocument === j || (D(u), a = !O); d = t[f++];) if (d(u, s || j, a)) {
                                    l.push(u);
                                    break
                                }
                                c && (H = w)
                ...
                var b, w, x, T, C, E, k, S, $, N, A, D, j, I, O, _, L, q, R, P = "sizzle" + 1 * new Date,
                    F = t.document, H = 0, W = 0, M = n(), z = n(), B = n(), U = function (t, e) {
                        return t === e && (A = !0), 0
                    }, Y = {}.hasOwnProperty, V = [], X = V.pop, Z = V.push, G = V.push, Q = V.slice, K = function (t, e) {
                    ...
                    }, dt = /^(?:input|select|textarea|button)$/i, pt = /^h\d$/i, ht = /^[^{]+\{\s*\[native \w/,
                    gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/,
                    ...
                    filter: {
                        TAG: function (t) {
                            ...
                            return 1 === i && 0 === o ? function (t) {
                                ...
                                var c, u, f, d, p, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode,
                                ...
                                if (m) {
                                    ...
                                    if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                        for (d = m, f = d[P] || (d[P] = {}), u = f[d.uniqueID] || (f[d.uniqueID] = {}), c = u[t] || [], p = c[0] === H && c[1], b = p && c[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (b = p = 0) || h.pop();) if (1 === d.nodeType && ++b && d === e) {
                                            u[t] = [H, p, b];
                                            break
                                        }
                ...
                return u.prototype = x.filters = x.pseudos, x.setFilters = new u, E = e.tokenize = function (t, n) {
                    ...
                    if (n = n || [], 1 === d.length) {
                        ...
                        for (o = ft.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]);) if ((l = x.find[a]) && (i = l(s.matches[0].replace(vt, yt), mt.test(r[0].type) && c(e.parentNode) || e))) {
            ...
            var Mt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
                zt = new RegExp("^(?:([+-])=|)(" + Mt + ")([a-z%]*)$", "i"), Bt = ["Top", "Right", "Bottom", "Left"],
                Ut = function (t, e) {
            ...
            var Jt = st.documentElement, te = /^key/, ee = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
                ne = /^([^.]*)(?:\.(.+)|)/;
            yt.event = {
                global: {}, add: function (t, e, n, i, o) {
                    ...
                    if (m && (l = m.events)) {
                        for (e = (e || "").match(Ot) || [""], c = e.length; c--;) if (a = ne.exec(e[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
                    ...
                    var e, n, i, o, r, s, a = yt.event.fix(t), l = new Array(arguments.length),
                        c = (Pt.get(this, "events") || {})[a.type] || [], u = yt.event.special[a.type] || {};
            ...
            yt.extend({
                htmlPrefilter: function (t) {
                    ...
                    if (!(vt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || yt.isXMLDoc(t))) for (s = T(a), r = T(t), i = 0, o = r.length; i < o; i++) O(r[i], s[i]);
                    if (e) if (n) for (r = r || T(t), s = s || T(a), i = 0, o = r.length; i < o; i++) I(r[i], s[i]); else I(t, a);
            ...
            var le = /^margin/, ce = new RegExp("^(" + Mt + ")(?!px)[a-z%]+$", "i"), ue = function (t) {
            ...
            yt.extend({
                ...
                style: function (t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        var o, r, s, a = yt.camelCase(e), l = de.test(e), c = t.style;
                ...
                yt.cssHooks[e] = {
                    get: function (t, n, i) {
                        ...
                        var o, r = i && ue(t), s = i && W(t, e, i, "border-box" === yt.css(t, "boxSizing", !1, r), r);
                ...
                if (e) return (parseFloat(q(t, "marginLeft")) || t.getBoundingClientRect().left - Yt(t, {marginLeft: 0}, function () {
                ...
                constructor: z, init: function (t, e, n, i, o, r) {
            ...
            yt.Animation = yt.extend(G, {
                ...
                fadeTo: function (t, e, n, i) {
                    ...
                    return "string" != typeof t && (n = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                        var e = !0, o = null != t && t + "queueHooks", r = yt.timers, s = Pt.get(this);
                        if (o) s[o] && s[o].stop && i(s[o]); else for (o in s) s[o] && s[o].stop && we.test(o) && i(s[o]);
                        for (o = r.length; o--;) r[o].elem !== this || null != t && r[o].queue !== t || (r[o].anim.stop(n), e = !1, r.splice(o, 1));
                        !e && n || yt.dequeue(this, t)
                    })
                }, finish: function (t) {
                    return !1 !== t && (t = t || "fx"), this.each(function () {
                        var e, n = Pt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = yt.timers,
                            s = i ? i.length : 0;
            ...
            yt.fn.extend({
                ...
                addClass: function (t) {
                    ...
                    if ("string" == typeof t && t) for (e = t.match(Ot) || []; n = this[l++];) if (o = K(n), i = 1 === n.nodeType && " " + Q(o) + " ") {
                    ...
                    return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : yt.isFunction(t) ? this.each(function (n) {
                        ...
                        var e, i, o, r;
                        if ("string" === n) for (i = 0, o = yt(this), r = t.match(Ot) || []; e = r[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== n || (e = K(this), e && Pt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Pt.get(this, "__className__") || ""))
                    })
                }, hasClass: function (t) {
                    var e, n, i = 0;
                    for (e = " " + t + " "; n = this[i++];) if (1 === n.nodeType && (" " + Q(K(n)) + " ").indexOf(e) > -1) return !0;
                    return !1
                }
            });
            var ke = /\r/g;
            ...
            yt.extend(yt.event, {
                trigger: function (t, e, i, o) {
                    var r, s, a, l, c, u, f, d = [i || st], p = ht.call(t, "type") ? t.type : t,
                    ...
                    if (s = a = i = i || st, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(p + yt.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[yt.expando] ? t : new yt.Event(p, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), e = null == e ? [t] : yt.makeArray(e, [t]), f = yt.event.special[p] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, e))) {
                        ...
                        for (r = 0; (s = d[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : f.bindType || p, u = (Pt.get(s, "events") || {})[t.type] && Pt.get(s, "handle"), u && u.apply(s, e), (u = c && s[c]) && u.apply && Rt(s) && (t.result = u.apply(s, e), !1 === t.result && t.preventDefault());
            ...
            var _e = /%20/g, Le = /#.*$/, qe = /([?&])_=[^&]*/, Re = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                Pe = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Fe = /^(?:GET|HEAD)$/, He = /^\/\//,
                We = {}, Me = {}, ze = "*/".concat("*"), Be = st.createElement("a");
            Be.href = $e.href, yt.extend({
                ...
                ajax: function (t, e) {
                    ...
                    var o, r, s, a, l, c, u, f, d, p, h = yt.ajaxSetup({}, e), g = h.context || h,
                        m = h.context && (g.nodeType || g.jquery) ? yt(g) : yt.event, v = yt.Deferred(),
                        y = yt.Callbacks("once memory"), b = h.statusCode || {}, w = {}, x = {}, T = "canceled", C = {
            ...
            vt.cors = !!Ye && "withCredentials" in Ye, vt.ajax = Ye = !!Ye, yt.ajaxTransport(function (t) {
                ...
                if (vt.cors || Ye && !t.crossDomain) return {
                    send: function (o, r) {
                        ...
                        e = function (t) {
                            return function () {
                                e && (e = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Ue[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                            }
            ...
            yt.ajaxSetup({
                ...
                setOffset: function (t, e, n) {
                    var i, o, r, s, a, l, c, u = yt.css(t, "position"), f = yt(t), d = {};
